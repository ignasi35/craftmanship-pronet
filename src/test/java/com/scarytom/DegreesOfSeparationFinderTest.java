...
public class DegreesOfSeparationFinderTest {
	...
	private IDegreesOfSeparationFinder buildTarget(
		...
		return new MatrixDegreesOfSeparationFinder(programmers);
	}
	...
	public void canFindDirectlyLinkedRecommendee() throws Exception {
		...
		IDegreesOfSeparationFinder degreesOfSeparationFinder = buildTarget(programmers);
		assertEquals(1, degreesOfSeparationFinder.degreesOfSeparationBetween(
				tom, davie));
	}
	...
	public void canFindIndirectlyLinkedRecommendee() throws Exception {
		...
		IDegreesOfSeparationFinder degreesOfSeparationFinder = buildTarget(programmers);
		assertEquals(2, degreesOfSeparationFinder.degreesOfSeparationBetween(
				tom, harry));
	}
